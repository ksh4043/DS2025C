# 최소 신장 트리 구현 알고리즘
# 프림(Prim) 알고리즘, 크루스컬(Kruskal) 알고리즘
# 크루스컬 알고리즘 :
# 버텍스와 간선 연결할 때 사이클이 생기면 연결하지 않음.
...
incheon, seoul, gangreung, daejeon, gwangju, busan = 0, 1, 2, 3, 4, 5


graph_size = 6
g1 = Graph(graph_size)
g1.graph[incheon][seoul] = 10; g1.graph[incheon][gangreung] = 15
g1.graph[seoul][incheon] = 10; g1.graph[seoul][gangreung] = 40; g1.graph[seoul][daejeon] = 11; g1.graph[seoul][gwangju] = 55
g1.graph[gangreung][incheon] = 15; g1.graph[gangreung][seoul] = 40; g1.graph[gangreung][daejeon] = 12
g1.graph[daejeon][seoul] = 11; g1.graph[daejeon][gangreung] = 12; g1.graph[daejeon][gwangju] = 20; g1.graph[daejeon][busan] = 30
